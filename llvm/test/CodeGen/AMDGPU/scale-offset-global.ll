...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX1250,GFX1250-TRUE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1310 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX13,GFX13-SDAG,GFX13-FAKE16 %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1310 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX13,GFX13-GISEL,GFX13-FAKE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1310 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX13,GFX13-SDAG,GFX13-TRUE16 %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1310 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX13,GFX13-GISEL,GFX13-TRUE16 %s
...
; GFX1250-FAKE16-LABEL: global_store_b16_idxprom:
...
;
; GFX1250-TRUE16-LABEL: global_store_b16_idxprom:
...
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v1.l, 1
; GFX1250-TRUE16-NEXT:    global_store_b16 v0, v1, s[0:1] scale_offset
; GFX1250-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: global_store_b16_idxprom:
; GFX13-FAKE16:       ; %bb.0: ; %entry
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v1, 1
; GFX13-FAKE16-NEXT:    global_store_b16 v0, v1, s[0:1] scale_offset
; GFX13-FAKE16-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: global_store_b16_idxprom:
; GFX13-TRUE16:       ; %bb.0: ; %entry
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v1.l, 1
; GFX13-TRUE16-NEXT:    global_store_b16 v0, v1, s[0:1] scale_offset
...
; GFX1250-NEXT:    s_endpgm
;
; GFX13-LABEL: global_atomicrmw_b32_idxprom:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    v_mov_b32_e32 v1, 1
; GFX13-NEXT:    global_atomic_add_u32 v0, v1, s[0:1] scale_offset scope:SCOPE_SYS
; GFX13-NEXT:    s_endpgm
entry:
  %idxprom = sext i32 %idx to i64
...
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_mov_b32 v2, 0
; GFX13-NEXT:    global_atomic_add_u64 v[0:1], v0, v[1:2], s[0:1] scale_offset th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
entry:
  %idxprom = sext i32 %idx to i64
